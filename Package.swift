...
let package = Package(
    ...
    products: [
        ...
        .library(name: "WorkQueueNIO",
                 targets: ["WorkQueueNIO"]),
    ...
    targets: [
        ...
        .target(
            name: "WorkQueueNIO",
            dependencies: [ "WorkQueue", .product(name: "NIO", package: "swift-nio") ]),
        ...
        .testTarget(
            name: "WorkQueueNIOTests",
            dependencies: [ "WorkQueue", "WorkQueueNIO", "WorkQueueTestUtilities" ]),
        .testTarget(
